...
class Returnspostapi4 extends CI_Controller
{
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $dummyarr       = array();
                ...
                $errorarr[$i] = $errorarr[$i];
                    ...
                    $errorstr  = $errorstr . ",(" . "'100','$fromstrcode','$fromstrname','$barcode','$line','$stylecode','$size','$qty','$rcvstrcode','$rcvstrname','$trantype','$error','$excell_no','$email','$errorexcell_no'" . ")";
                    
                    
                    
                }
                for ($i = 0; $i < sizeof($keys); $i++) {
                    $unicinsrtstr = $unicinsrtstr . str_replace('totqty', $approvalcodearr[$keys[$i]]['totqty'], $valuesstr1[$i]);
                }
                if (!in_array(0, $flagarr)) {
                    ...
                    $inserterrorqry = $this->Model_connectdb1->insrterrorlog(substr($errorstr, 1));
                }
